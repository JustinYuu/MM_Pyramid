...
from dataloader_avvp import *
from main_network import AVVPNet
...
def main():
    ...
    parser.add_argument(
        "--audio_dir", type=str, default=data_dir + 'feats/vggish/', help="audio dir")
    parser.add_argument(
        "--video_dir", type=str, default=data_dir + 'feats/res152/',
        help="video dir")
    parser.add_argument(
        "--st_dir", type=str, default=data_dir + 'feats/r2plus1d_18/',
        help="video dir")
    parser.add_argument(
    ...
    parser.add_argument(
        "--model", type=str, default='MM_Pyramid', help="with model to use")
    parser.add_argument(
    ...
    parser.add_argument('--levels', type=int, default=4, help='levels of TCN')
    ...
    model = AVVPNet(args.head, args.hid_dim, args.ffn_dim, n_channels).to('cuda')
